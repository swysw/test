...
uint8_t mpu_dmp_init(void)
{
    ...
    {
        long gyro_offset[3]; // 使用 long 类型以匹配 dmp_set_gyro_bias 函数参数
        MPU_Get_Gyro_Offset((short*)&gyro_offset[0], (short*)&gyro_offset[1], (short*)&gyro_offset[2]);
        dmp_set_gyro_bias(gyro_offset);
